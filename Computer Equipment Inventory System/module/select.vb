...
#Region "Report"
    Public Sub reports(ByVal sql As String, ByVal rptname As String, ByVal crystalRpt As Object)
        Try
            ...
            strReportPath = Application.StartupPath & "C:\Users\63955\OneDrive - STI Valencia\Desktop\Clyde\Computer Equipment Inventory System\Computer Equipment Inventory System\reports" & reportname & ".rpt"
            With reportdoc
                .Load(strReportPath)
            ...
            End With
        Catch ex As Exception
            MsgBox(ex.Message & "No Crystal Reports have been Installed haha")
        End Try
        con.Close()
        da.Dispose()
    End Sub

Public Class frm_stockmaster
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        ...
        sql = "INSERT INTO  `tblstock_in_out` (`ITEMID`, `QTY`,`TRANSACTIONDATE`, `TOTALPRICE`, `REMARKS`)" & _
           " VALUES ('" & txtitemid.Text & "','" & txtqty.Text & "','" & Format(Now, "yyyy-MM-dd") & "','" & txtprice.Text & _
           "','StockIn')"
        createNoMsg(sql)
    ...
    Private Sub btnupdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnupdate.Click
        sql = "UPDATE tblitems SET `NAME`='" & txtname.Text & "', `DESCRIPTION`='" & txtdescription.Text & "', `TYPE`='" & cbotype.Text & "', `PRICE`='" & txtprice.Text & "'" & _
    ...
    Private Sub pnl_stockmaster_Paint(sender As Object, e As PaintEventArgs) Handles pnl_stockmaster.Paint
